...
export const HeroSection: React.FC<HeroSectionProps> = ({ onStartFree, onBookDemo }) => {
  return (
    <section className="text-center mt-16 sm:mt-24 mb-16 max-w-4xl mx-auto animate-fade-in-up">
      ...
      <p className="mt-6 text-base sm:text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
