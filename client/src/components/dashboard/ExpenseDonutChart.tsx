...
export const ExpenseDonutChart: React.FC = () => {
  ...
  return (
    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
      <div>
        ...
        <div className="relative w-36 h-36 mx-auto my-2 flex items-center justify-center">
          ...
          {/* Center Text */}
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center animate-scale-in" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="space-y-2 mt-5 text-xs">
          {categories.map((c, idx) => (
            <div 
              key={c.name} 
              className="flex items-center justify-between hover:bg-slate-50 p-1 rounded-lg transition animate-fade-in-up"
